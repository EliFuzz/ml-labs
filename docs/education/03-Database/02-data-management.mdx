      ...
      <td>
        ```mermaid
          ...
          subgraph Centralized
            ...
            service1(Service) e1@--> |request| counter[[Counter]]
            service2(Service) e2@--> |request| counter[[Counter]]
          end
          ...
          subgraph Decentralized
            ...
            service3 e3@--> |1,4,7| service3
            service4 e4@--> |3,6,9| service4
            service5 e5@--> |2,5,8| service5
          end
...
<Tabs queryString="primary">
  <TabItem value="data-synchronization-sharding" label="Sharding/Partitioning">
    <Tabs queryString="secondary">
      <TabItem value="sharding-overview" label="Overview" attributes={{className:"tabs_vertical"}}>
            ...
            <tr>
              ...
              <td>
                ```mermaid
                    ...
                    table(Table) e1@--> hashFn(Hash Function)

                    hashFn e2@--> hashRing{Hash Ring}

                    hashRing e3@--> shard1(Shard 1)
                    hashRing e4@--> shard2(Shard 2)
                    hashRing e5@--> shard3(Shard N)
            ...
            <tr>
              ...
              <td>
                ```mermaid
                    ...
                    table(( )) e1@--> |shard key<br/>delivery zone| hashTable(( ))
                    hashTable e2@--> |s1| shard1(( ))
                    hashTable e3@--> |s2| shard2(( ))
                    hashTable e4@--> |s3| shard3(( ))
                    hashTable e5@--> |s4| shard4(( ))
            ...
            <tr>
              ...
              <td>
                ```mermaid
                    ...
                    table(Users) e1@--> shardUS(US Users)
                    table(Users) e2@--> shardEU(EU Users)
                    table(Users) e3@--> shardAsia(Asia Users)
            ...
            <tr>
              ...
              <td>
                ```mermaid
                    ...
                    table(( )) e1@--> |shard key<br/>col1| hashFn(Hash Function)
                    hashFn e2@--> hashTable(( ))
                    hashTable e3@--> shard1(( ))
                    hashTable e4@--> shard2(( ))
            ...
            <tr>
              ...
              <td>
                ```mermaid
                    ...
                    table(( )) e1@--> |0-50| shard1(( ))
                    table e2@--> |50-100| shard2(( ))
                    table e3@--> |100+| shard3(( ))
  ...
  <TabItem value="data-synchronization-replication" label="Replication">
    <Tabs queryString="secondary">
      <TabItem value="replication-overview" label="Overview" attributes={{className:"tabs_vertical"}}>
            ...
            <tr>
                ...
                <td>
                    ```mermaid
                        ...
                        source[(Source)] e1@--> replica[(Replica)]
                        replica e2@--> source
            ...
            <tr>
                ...
                <td>
                    ```mermaid
                        ...
                        source[(Source)] e1@--> replica1[(Replica)]
                        source e2@--> replica2[(Replica)]
                        source e3@--> replica3[(Replica)]
            ...
            <tr>
                ...
                <td>
                    ```mermaid
                        ...
                        source[(Source)] e1@--> db[(DB)]

                        db e2@--> replica1[(Replica)]
                        db e3@--> replica2[(Replica)]
                        db e4@--> replica3[(Replica)]
            ...
            <tr>
                ...
                <td>
                    ```mermaid
                        ...
                        replica1[(Replica)] e1@--> source[(Source)]
                        replica2[(Replica)] e2@--> source
                        replica3[(Replica)] e3@--> source
            ...
            <tr>
              ...
              <td>
                ```mermaid
                   ...
                   source[(Source)] e1@--> replicaA[(Replica)]
                   source e2@--> replicaB[(Replica)]
            ...
            <tr>
              ...
              <td>
                ```mermaid
                    ...
                    coordinator e3@--> a_dbA
                    coordinator e4@--> a_dbB
                    ...
                    coordinator e7@--> b_dbA
                    coordinator e8@--> b_dbB
              ...
              <td>
                ```mermaid
                    ...
                    subgraph SourcesA[ ]
                        ...
                        serverA(Server) e1@--> |read/write| sourceA[(Source)]
                        serverA e2@--> |read| replicaA[(Replica)]
                        sourceA e3@-.-> replicaA
                    end
                    ...
                    subgraph SourcesB[ ]
                        ...
                        serverB(Server) e4@--> |read/write| sourceB[(Source)]
                        serverB e5@--> |read| replicaB[(Replica)]
                        sourceB e6@-.-> replicaB
                    end
              ...
              <td>
                ```mermaid
                    ...
                    subgraph typeA[Circular Topology]
                        ...
                        a_dbA[(Source)] e1@---> a_dbB[(Source)]
                        a_dbA[(Source)] e2@---> a_dbC[(Source)]
                        a_dbB[(Source)] e3@---> a_dbD[(Source)]
                        a_dbC[(Source)] e4@---> a_dbD[(Source)]
                    end
              ...
              <td>
                ```mermaid
                    ...
                    subgraph read[Read]
                        ...
                        readCoordinator e1@--> |response| readClient
                        readCoordinator e2@<--> |read quorum<br/>response| read_dbA[( )]
                        readCoordinator e3@<--> |read quorum<br/>response| read_dbB[( )]
                        readCoordinator e4@<--> |read quorum<br/>response| read_dbC[( )]

                        readClient(Client) e5@--> |read| readCoordinator(Coordinator)
                    end
                    ...
                    subgraph write[Write]
                        ...
                        writeClient(Client) e6@<--> |write<br/>respond| writeCoordinator(Coordinator)
                        writeCoordinator e7@<--> |prepare<br/>acknowledge| write_dbA
                        writeCoordinator e8@<--> |commit<br/>acknowledge| write_dbA

                        writeCoordinator e9@<--> |prepare<br/>acknowledge| write_dbB
                        writeCoordinator e10@<--> |commit<br/>acknowledge| write_dbB
                    end
...
<Tabs queryString="primary">
  ...
  <TabItem value="communication-patterns-detailed" label="Patterns">
    <Tabs queryString="secondary">
      <TabItem value="communication-patterns-choreography" label="Choreography" attributes={{className:"tabs_vertical"}}>
        <table>
          <thead>
          <tr>
            <th>Aspect</th>
          ...
          <tr>
            ...
            <td>
              ```mermaid
                ...
                broker e2@--> |subscribe| replica1
                broker e3@--> |subscribe| replica2

                replica1 e4@-.-> |listen| broker
                replica2 e5@-.-> |listen| broker
          ...
          <tr>
            ...
            <td>
              ```mermaid
                ...
                command e1@--> |write| write
                write e2@--> |event| event
          ...
          <tr>
            ...
            <td>
              ```mermaid
                ...
                service e1@--> |read data<br/>from multiple sources| dqp
                dqp e2@--> |read| sql
                dqp e3@--> |read| bq
          ...
          <tr>
            ...
            <td>
                ```mermaid
                  ...
                  service e1@--> |item 1 added| eventStore
                  service e2@--> |item 2 added| eventStore
                  service e3@--> |item 3 added| eventStore

                  eventStore e4@--> |publish event| eventBus
                  eventBus e5@--> |event published| read

                  eventStore e6@--> |replay event| replay
          ...
          <tr>
            ...
            <td>
              ```mermaid
                ...
                service1 e1@--> |read/write| db1
                service2 e2@--> |read/write| db2
          ...
          <tr>
            ...
            <td>
              ```mermaid
                ...
                service e3@--> |event| Orchestration

                step1 e4@<--> serviceA(Service)
                step2 e5@<--> serviceB(Service)
                serviceB e6@<--> serviceC(Service)
                step3 e7@<--> serviceD(Service)
          ...
          <tr>
            ...
            <td>
              ```mermaid
                ...
                service e1@--- |1. event| transaction

                transaction e2@--> |upsert/delete| db
                transaction e3@--> |insert| outbox

                relay(Message Relay) e4@--> |2. read| outbox
                relay e5@--> |3. publish| broker([Message Broker])
          ...
          <tr>
            ...
            <td>
              ```mermaid
                ...
                sources e1@--> filter(Data Filtering)
                filter e2@--> clean(Data Cleaning)
                clean e3@--> filter2(Data Filtering)
                filter2 e4@--> aggregation(Data Aggregation)
                aggregation e5@--> db[(Destination<br/>Data Warehouse)]
        ...
        <tr>
          ...
          <td>
            ```mermaid
              ...
              app e1@--> |5. update cache| cache
              app e2@--> |1. read| cache
              cache e3@--> |2. miss| app
              app e4@--> |3. read| db
              db e5@--> |4. get data| app
        ...
        <tr>
          ...
          <td>
            ```mermaid
              ...
              app e1@--> |1. read| cache
              cache e2@~~~|2. miss| cache
              cache e3@--> |3. read| db
              db e4@--> |4. get data| cache
              cache e5@--> |5. update cache| cache
        ...
        <tr>
          ...
          <td>
            ```mermaid
              ...
              app e1@--> |1. write db| db
              cache e2@--> |2. read from cache<br/>if data exists| app
              db e3@--> |3.1. read from DB<br/>if data missing| app
              app e4@--> |3.2. update cache| cache
        ...
        <tr>
          ...
          <td>
            ```mermaid
              ...
              app e1@--> |1. write to cache constantly| cache
              cache e2@--> |2. write to DB once in a while| db
        ...
        <tr>
          ...
          <td>
            ```mermaid
              ...
              app e1@--> |1. write| cache
              cache e2@--> |2. write immediately| db
