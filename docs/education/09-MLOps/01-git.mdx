...
<Tabs queryString="primary">
      ...
      <tbody>
        <tr>
            <td>
                ...
                developer1 e1@--> |edit| workingDir1
                workingDir1 e2@--> |git add| stagingArea1
                stagingArea1 e3@--> |git commit| localRepo1
                end
                ...
                developer2 e4@--> |edit| workingDir2
                workingDir2 e5@--> |git add| stagingArea2
                stagingArea2 e6@--> |git commit| localRepo2
                end
                ...
                Local1 e7@--> |git push| Remote
                Remote e8@--> |git fetch| Local1

                Local2 e9@--> |git push| Remote
                Remote e10@--> |git fetch| Local2
  ...
  <TabItem value="ci-cd" label="CI/CD">
    ...
    plan(Plan) e1@--> code(Code) e2@--> build(Build)
    end

    subgraph integration[Continuous Integration]
    direction LR

    integrate(Integrate) e3@--> test(Test)
    end
    ...
    agile e4@--> integration e5@--> delivery e6@--> deployment
